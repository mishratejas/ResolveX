...
// ==================== OWN PROFILE ====================
router.get("/profile", adminAuth, getAdminProfile); // 🚀 NEW
router.put("/profile", adminAuth, updateAdminProfile); // 🚀 NEW: Admin can update their own name/phone/org/profile photo
