...
// { currentPassword, newPassword }, but neither the route nor this controller
// existed, so "Change Password" always failed. Verifies the current password
// against the stored hash, then hashes and saves the new one.
