                ...
                >
                  <div className="flex flex-col lg:flex-row justify-between gap-6">
                    ...
                    <div className="flex flex-col items-end justify-center gap-3 min-w-[250px] border-t lg:border-t-0 lg:border-l border-gray-100 pt-4 lg:pt-0 lg:pl-6">
                      ...
                      {/* Priority Override — admin-only */}
                      <div className="w-full">
                        <label className="block text-xs font-bold text-gray-500 mb-1">
                          Priority {complaint.manualPriorityOverridden && (
                      ...
                      {(activeTab === 'assigned' || activeTab === 'resolved') && complaint.assignedTo && (
                        <button 
                          ...
                          className="w-full py-2 mt-2 text-sm font-bold text-blue-700 bg-blue-50 rounded-lg hover:bg-blue-100 border border-blue-200 transition-colors flex items-center justify-center gap-2 shadow-sm"
                        >
