                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      {ownComplaints > 0
                        ? "We found similar complaints, including one you've already submitted. Review them before creating another complaint."
                        : `We found ${duplicates.length} similar complaint${
                            duplicates.length > 1 ? "s" : ""
                          } in your area. Instead of creating a new one, you can upvote an existing complaint to increase its priority.`}
                    </p>
                  </div>
                  <button
                    onClick={onClose}
                  ...
                  {duplicates.map((complaint) => (
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between gap-3 mb-3">
                        ...
                        <span className="px-2 py-1 rounded-full bg-purple-100 text-purple-700 text-xs font-semibold whitespace-nowrap">
                          {complaint.similarity}% Match
                        </span>
                      </div>
                      ...
                      <div className="flex items-center gap-4 text-xs text-gray-500 mb-3">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          {complaint.voteCount || 0} upvote{(complaint.voteCount || 0) !== 1 ? 's' : ''}
                        </span>
                      </div>

                      {complaint.isOwnComplaint ? (
                        <div className="flex items-center justify-center gap-2 text-blue-700 text-sm bg-blue-50 border border-blue-200 p-2 rounded-lg font-medium">
                         ✓ Already Reported by You
                        </div>
