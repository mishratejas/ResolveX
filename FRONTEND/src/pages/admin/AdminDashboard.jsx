...
//   // State for Admin Workspace Info
//   const [adminInfo, setAdminInfo] = useState({
//     organizationName: 'ResolveX Admin',
//     workspaceCode: '------',
//     name: 'Administrator',
...
//           setDashboardData(prev => ({
//             ...prev,
//             // Ensure the data structure exactly matches what Recharts needs
//             performanceTrends: (chartRes.data.dailyComplaints || []).map(day => ({
//               date: day.day || formatDate(day.date),
//               // Make sure total is always at least as big as resolved
...
//               resolved: dept.resolved || 0, // Authentic data only
//               color: getDepartmentColor(dept.name)
//             }))
//           }));
//         }
...
//   const handleViewStaff = () => navigate('/admin/staff');
//   const handleViewUsers = () => navigate('/admin/users');
//   const handleViewIssues = () => navigate('/admin/issues');
...
//               <Icon className={`w-6 h-6 ${color.text}`} />
//             </div>
//             {/* 🚀 Removed the Percentage Pill from here */}
//           </div>
...
//                     <p className="text-sm">No trend data available for this time range.</p>
//                   </div>
//                 ) : (
//                   <ResponsiveContainer width="100%" height="100%">
...
//                         tickLine={false}
//                         dx={-10}
//                         allowDecimals={false} // Clean up decimals
//                       />
//                       <Tooltip
//                         contentStyle={{ 
...
//                         }}
//                       />
//                       {/* Render Total line FIRST so it sits behind Resolved if they overlap */}
//                       <Line 
//                         type="monotone" 
//                         dataKey="total" 
//                         name="Total Active"
//                         stroke="#f97316" 
//                         strokeWidth={3}
//                         dot={{ r: 4, strokeWidth: 2, stroke: '#ea580c', fill: '#fff' }}
...
//                         stroke="#10b981" 
//                         strokeWidth={3}
//                         dot={{ r: 4, strokeWidth: 2, stroke: '#059669', fill: '#fff' }}
//                       />
//                     </RechartsLine>
//                   </ResponsiveContainer>
//                 )}
...
//                   })
//                 ) : (
//                   // 🚀 FIXED: Removed static data, now shows an empty state gracefully
...
//                   <div className="text-center p-3 bg-gradient-to-br from-red-50 to-rose-50 rounded-lg border border-red-200">
//                     <div className="text-2xl font-bold text-gray-900">
//                       {dashboardData.stats.avgResolutionTime || 0}d
//                     </div>
//                     <div className="text-xs text-gray-600 font-medium">Avg Resolution</div>
//                   </div>
//                 </div>
...
//           {/* 🚀 NEW GRID: Top Performers now sits alone nicely since Recent Activity was removed */}
...
//                   ))
//                 ) : (
//                   // 🚀 FIXED: Removed static users. Shows an empty state now.
